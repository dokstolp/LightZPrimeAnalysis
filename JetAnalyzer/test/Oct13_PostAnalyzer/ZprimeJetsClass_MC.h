...
public :
   ...
   TH1F *h_jet1pt, *h_dphimin, *h_deltar_cut, *h_deltar, *h_HT[11], *h_nJets[11], *h_nGoodJets[11], *h_pfMET[11], *h_pfMETPhi[11], *h_j1Pt[11], *h_j1Eta[11], *h_j1Phi[11], *h_j1etaWidth[11], *h_j1phiWidth[11], *h_j1etaWidthInECal[11], *h_j1etaWidthInHCal[11], *h_j1phiWidthInECal[11], *h_j1phiWidthInHCal[11], *h_j1nCons[11], *h_j1CEF[11], *h_j1NEF[11], *h_j1CHF[11], *h_j1NHF[11];
