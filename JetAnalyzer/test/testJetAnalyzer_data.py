...
from LightZPrimeAnalysis.JetAnalyzer.JetAnalyzer_data_cfi import *
...
process.source = cms.Source("PoolSource", fileNames = cms.untracked.vstring('/store/data/Run2016D/SinglePhoton/AOD/PromptReco-v2/000/276/315/00000/2477C5F7-FC44-E611-9394-02163E01464C.root'))#
...
#process.source = cms.Source("PoolSource", fileNames = cms.untracked.vstring('/store/mc/RunIISpring16DR80/ZJetsToNuNu_HT-400To600_13TeV-madgraph/AODSIM/PUSpring16_80X_mcRun2_asymptotic_2016_v3_ext1-v1/00000/085F9D18-0451-E611-9A17-FA163EC2FCE4.root'))
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('JetAnalyzer_MET.root'))
#addFilterInfoAOD_ = True
process.load("LightZPrimeAnalysis.JetAnalyzer.JetAnalyzer_data_cfi")
