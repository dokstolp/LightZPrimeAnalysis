...
public :
   ...
   TH1F *h_dphimin,*h_deltar_cut,*h_deltar, *h_metFilters[8], *h_HLTPFMET300[8], *h_HLTPFMET170_HBHECleaned[8], *h_HT[8], *h_nJets[8], *h_nGoodJets[8], *h_pfMET[8], *h_pfMETPhi[8], *h_j1Pt[8], *h_j1Eta[8], *h_j1Phi[8], *h_j1etaWidth[8], *h_j1phiWidth[8], *h_j1etaWidthInECal[8], *h_j1etaWidthInHCal[8], *h_j1phiWidthInECal[8], *h_j1phiWidthInHCal[8], *h_j1nCons[8], *h_j1CEF[8], *h_j1NEF[8], *h_j1CHF[8], *h_j1NHF[8];
