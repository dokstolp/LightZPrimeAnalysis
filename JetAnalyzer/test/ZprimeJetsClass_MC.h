...
public :
   ...
   TH1F *h_dphimin, *h_deltar_cut, *h_deltar, *h_HT[9], *h_nJets[9], *h_nGoodJets[9], *h_pfMET[9], *h_pfMETPhi[9], *h_j1Pt[9], *h_j1Eta[9], *h_j1Phi[9], *h_j1etaWidth[9], *h_j1phiWidth[9], *h_j1etaWidthInECal[9], *h_j1etaWidthInHCal[9], *h_j1phiWidthInECal[9], *h_j1phiWidthInHCal[9], *h_j1nCons[9], *h_j1CEF[9], *h_j1NEF[9], *h_j1CHF[9], *h_j1NHF[9];
